...
if (isset($_GET['f_no'])) {
 ...
 //$rate = 24;
          ...
          $checkStats = "SELECT * FROM `settings_rates`";
                $statusResults = mysqli_query($conn,$checkStats);
                if(!$statusResults){
                  die("Error: ".mysqli_error($conn));
                }
                foreach ($statusResults as $statusResults4) {
                  // code...
               $rate =   $statusResults4["rate"];
                }
    ...
    // update farmers table ~ last paid
    ...
    <div id="printable">
        <table id="receipt"  >
            ...
            <th colspan="2"  ><h1>Ummoja Dairy Payment Receipt</h1></th>
            </thead>
            <tbody>
